...
public class ContestController {
    ...
    public ResponseEntity<Long> createContest(
        ...
        Long contestId = contestService.createContest(request, images, poster, attachments, user.getId());
    ...
    public ResponseEntity<ContestDetailResponse> getContest(
        ...
        ContestDetailResponse contest = contestService.getContest(contestId, user.getId());
    }
}
